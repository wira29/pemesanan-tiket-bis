          ...
          <nav class="navbar navbar-expand-lg p-0">
            ...
            <div class="d-block d-lg-none py-4">
              <a href="../main/index.html" class="text-nowrap logo-img">
                <img src="{{ asset('') }}assets/travel-logo.png" width="80" class="dark-logo" alt="Logo-Dark" />
                <img src="{{ asset('') }}assets/travel-logo.png" width="80" class="light-logo" alt="Logo-light" />
              </a>
            </div>
