...
@section('content')
    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            ...
            <div class="col-9">
                <h4 class="fw-semibold mb-8">Halaman Edit Invoice</h4>
        ...
        <div class="col-md-12">
            <div class="card position-relative overflow-hidden">
                <form action="{{ route('invoices.update', $invoice->id) }}" method="POST">
                    ...
                    <input type="hidden" id="travel_id" name="travel_id" value="{{ old('travel_id', $invoice->travel_id) }}">
                    <input type="hidden" id="passengers" name="passengers" value="{{ old('passengers', implode(',', $invoice->tickets->pluck('ticket_id')->toArray())) }}">
                    <div class="px-4 py-3 border-bottom">
                    <h4 class="card-title mb-0">Formulir Edit Invoice</h4>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="date" class="form-control" value="{{ old('date', $invoice->date->format('Y-m-d')) }}" id="date">
                                    @error('date')
                            ...
                            <div class="col-md-4 mb-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="total_price" class="form-control" value="{{ old('total_price', $invoice->total_price) }}" id="total_price">
                                    @error('total_price')
                                        <span class="text-danger" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
...
<script>
    $(document).ready(function() {
        ...
        $('#rute').change(function () {
            ...
            passengers = passengers ? passengers.split(',') : [];

            $.get(`/tickets/getTicketByTravel/${travelId}`, function (res) {
                console.log(res.tickets, passengers);
                let html = ''
                    ...
                    html += `<tr>
                        <td>
                            <input
                                ...
                                name="ticket_ids[]"
                                value="${ticket.id}"
                                ${passengers.indexOf(ticket.id) > -1 ? 'checked' : ''}
                            >
                        </td>
                        <td>
                            ${ticket.seat_no}
